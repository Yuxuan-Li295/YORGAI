    ...
    >
      ...
      <div className={sectionStyles}>
        ...
        <div className={optionBoxStyles}>
          <ConfigSideBarBadge variant="model">GPT 3.5</ConfigSideBarBadge>
          <ConfigSideBarBadge variant="model">Claude</ConfigSideBarBadge>
      ...
      <div className={sectionStyles}>
        <div className={titleStyles}>内容</div>
        <MultiLineInputField
          width={308}
          height={60}
          value=""
      ...
      <div className={sectionStyles}>
        <div className={titleStyles}>风格</div>
        <Dropdown
      ...
      <div className={sectionStyles}>
        <div className={titleStyles}>知识库</div>
        <div className={optionBoxStyles}>
          <ConfigSideBarBadge variant="">知识库1</ConfigSideBarBadge>
          <ConfigSideBarBadge variant="">火星电台3.0</ConfigSideBarBadge>
          <ConfigSideBarBadge variant="additional">+3</ConfigSideBarBadge>
          <div className={arrowRightStyles}>
            <ArrowAngleRightMd />
          </div>
        </div>
      ...
      <div className={sectionStyles}>
        <div className={titleStyles}>语气</div>
        <RadioButton size={2} label={["普通", "轻松"]} />
      </div>
      <div className={sectionStyles}>
        <div className={titleStyles}>长度</div>
