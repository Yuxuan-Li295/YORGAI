...
type SingleLineInputFieldProps = {
  error?: boolean;
  fontStyles?: string;
  width: number;
  height: number;
...
export const SingleLineInputField: React.FC<SingleLineInputFieldProps> = ({
  error = false,
  ...
  const { value, type, placeholder, disabled, onChange } = props;
  ...
  const handleInputChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Call the onChange prop function with the event target value
